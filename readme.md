...
But anybody can add their own code inside extension and library directory. While basic code of this system is PHP (since version 2.0.0), AI will scan all php files in those directories and load-up as AI executing arguments.
